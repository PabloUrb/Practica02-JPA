 ...
 * @author pablourbano
 */
public class ultimaConexion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Empleado e = (Empleado) request.getSession().getAttribute("empleado");
            try {
                Historial h = miEjb.ultimaConec(e);
                request.setAttribute("ok", "1");
                request.setAttribute("status", "Last login de " + e.getNombrecompleto() + " "  + h.getFechahora());
